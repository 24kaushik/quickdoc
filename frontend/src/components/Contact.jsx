      ...
      <div class="my-20 mt-32">
            <div class="grid sm:grid-cols-2 items-start gap-14 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md font-[sans-serif]">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-4">"Have questions, feedback, or need assistance with bookings? We're here to help—feel free to reach out to us anytime!"</p>
                    ...
                    <div class="mt-12">
                        ...
                        <ul class="mt-4">
                            <li class="flex items-center">
                                ...
                                <a href="mailto:kaushik.s.contact@gmail.com" class="text-[#007bff] text-sm ml-4">
                                    <small class="block">Mail</small>
                                    <strong>kaushik.s.contact@gmail.com</strong>
                                </a>
                            </li>
                        </ul>
                    </div>
