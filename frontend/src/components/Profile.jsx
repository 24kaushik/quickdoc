...
const Profile = () => {
  ...
  return (
    <div className="py-32 flex flex-col bg-gray-100">
      ...
      <div className="mx-10 my-5">
        ...
        <div className="m-10 flex flex-wrap justify-center">
          {appointments.map(({ state, doctorType, date, person }) => {
            return (
              <div class="max-w-sm p-6 bg-gray-200 border border-gray-200 rounded-lg shadow drop-shadow dark:bg-gray-800 dark:border-gray-700 m-5">
                <a href="#">
